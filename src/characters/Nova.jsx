...
const Nova = () => {
  ...
  useEffect(() => {
    fetch(
      "https://gateway.marvel.com/v1/public/characters?nameStartsWith=nova&orderBy=-modified&limit=100&ts=1&apikey=47c728e2933b98677639c9ef3bcbed3c&hash=e926e192b0df9aaff901a57cb66e154a"
    )
