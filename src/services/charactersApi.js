...
export const charactersApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getCharacterEvents: builder.query({
      query: ({ characterId, orderBy, limit, offset }) =>
        createRequest(
          `/characters/${characterId}/events?orderBy=${orderBy}&limit=${limit}&offset=${offset}&ts=1&apikey=47c728e2933b98677639c9ef3bcbed3c&hash=e926e192b0df9aaff901a57cb66e154a`
        ),
    }),
